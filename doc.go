...
More information at https://github.com/senzing-garage/go-rest-api-service-legacy
...
More information can be found in the [pkg/github.com/senzing-garage/go-rest-api-service-legacy/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing-garage/go-rest-api-service-legacy/anotherpackage"
	)
